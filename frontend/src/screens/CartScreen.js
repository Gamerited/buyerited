...
export default function CartScreen(props) {
    ...
    const removeFromCartHandler = (id) => {
        // here we have to make action to delete the product
            ...
            <div className="col-1">
                <div className="card card-body">
                    <ul>
                        ...
                        <li>
                            <button type="button" onClick={checkOutHandler} className="primary block" disabled={cartItems.length === 0}>                            Proceed to checkout
                             </button>
                        </li>
                    </ul>
                </div>
